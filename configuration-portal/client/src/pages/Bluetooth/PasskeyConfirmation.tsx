...
function PasskeyConfirmation({ btConnection, passkey, onDecline, onAccept }) {
    return (
        <>
            {btConnection === Connection.ADVERTISING ?
                <section className={classNames("my-8", "flex", "justify-center")}>
                    <div className="max-w-[85%] py-5 px-7 border-" style={{ border: "1px solid #60687687" }}>
                        {btConnection === Connection.PAIRING ?
                            <div>Passkey: {passkey}</div> :
                            <></>
                        }
                        <div className="text-center text-4xl">
                            <div className="text-base text-gray-400">Passkey</div>
                            <div>31151</div>
                        </div>
                        <div className="mt-2 flex flex-row items-center mb-1">
                            ...
                            <div className="ml-1 text-sm font-medium text-gray-200">
                                Please verify that this passkey is identical to the one presented on the E-Ink display
                            </div>
                        </div>
